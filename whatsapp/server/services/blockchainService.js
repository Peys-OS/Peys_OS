...
const NETWORKS = {
  base_sepolia: {
    chainId: 84532,
    name: 'Base Sepolia',
    rpcUrl: process.env.VITE_RPC_URL_BASE_SEPOLIA || 'https://base-sepolia.g.alchemy.com/v2/***REMOVED***',
    escrowAddress: process.env.VITE_ESCROW_CONTRACT_ADDRESS || '***REMOVED***',

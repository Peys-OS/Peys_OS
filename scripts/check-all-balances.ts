...
const networks = [
  ...
  {
    name: "Base Sepolia",
    rpc: process.env.BASE_SEPOLIA_RPC || "https://base-sepolia.g.alchemy.com/v2/***REMOVED***",
    chainId: 84532,
    nativeSymbol: "ETH",
    tokens: [
  ...
  {
    name: "Celo Alfajores",
    rpc: process.env.CELO_ALFAJORES_RPC || "https://celo-sepolia.g.alchemy.com/v2/***REMOVED***",
    chainId: 44787,
    nativeSymbol: "CELO",
    tokens: [
